...
export class KioskPage {
    ...
    public kioskAddAdmin: string;
    
    public settings: Locator;
    public attendanceSettings: Locator;
    public kioskSetupSettings: Locator;
    public addDeviceSettings: Locator;
    public kioskNameTextBox: Locator;
    public devicetype: Locator;
    public deviceTypeOption: Locator;
    public officeLocationDropdown: Locator;
    public officeSelectionOption: Locator;
    public addAdmins: Locator;
    public employeeNameFilter: Locator;
    public employeeCheckBox: Locator;
    public addButtonAdminSelection: Locator;
    public addButtonDeviceDetailspage: Locator;
    public completeLaterButton: Locator;
    public deleteOption: Locator;
    public deleteOnConfirmationpopup: Locator;
